...
![Top 5 most common skills in 'Top-Paying Data Analyst Jobs](https://github.com/adarshchhetri9/sql/blob/main/assets/top_skills_data_analyst.png)
*Bar graph visualizing the salary for the top 5 In-high demand Skill for data analysts; ChatGPT generated this graph from my SQL query results
and you can find the sql query on project_sql/3_top_demanding_skill.sql*
